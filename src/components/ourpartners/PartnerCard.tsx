...
// Partner after translation is applied in OurPartners.tsx
type TranslatedPartner = Partner & {
  description: string;
  category: string;
};
            ...
            <Box sx={{ position: 'relative', height: 155, overflow: 'hidden', flexShrink: 0 }}>
              ...
              <Box
                sx={{
                  ...
                  inset: 0,
                  background:
                    'linear-gradient(to top, rgba(5,8,20,0.82) 0%, rgba(0,0,0,0.2) 55%, transparent 100%)',
                  pointerEvents: 'none',
                }}
              />
