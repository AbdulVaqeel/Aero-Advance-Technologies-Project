...
//         backgroundImage: 'url(https://images.pexels.com/photos/29506499/pexels-photo-29506499.jpeg)',
  ...
  return (
    <Box
      sx={{
        ...
        height: { xs: 'auto', md: '650px' },
        backgroundImage:
          'url(https://images.pexels.com/photos/29506499/pexels-photo-29506499.jpeg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        display: 'flex',
        alignItems: 'center',
